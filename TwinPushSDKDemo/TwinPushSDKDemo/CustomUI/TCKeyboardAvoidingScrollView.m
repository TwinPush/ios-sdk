//
//  TCKeyboardAvoidingScrollView.m
//
...
@interface TCKeyboardAvoidingScrollView () <UITextFieldDelegate, UITextViewDelegate> {
...
@implementation TCKeyboardAvoidingScrollView
